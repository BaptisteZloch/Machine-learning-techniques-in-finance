...
class HMM_Model:
    ...
    def Best_BIC(self):
        ...
        for ii in range(len(self.Component2)):
            Hold_bic.append(
                self.Component2[ii][1][0][1]
            )  #     print(count13)   # This derermines the mixture component
    ...
    def Best_States(self):
        ...
        self.Model = GMMHMM(
            n_components=int(self.BEST[1]),
            n_mix=int(self.BEST[0]),
    ...
    def AIC_BIC(self):
        ...
        for ii in range(1, self.Max_mixture + 1):
            ...
            self.num_params = (
                ...
                + self.Max_state * (ii - 1)
                + (ii * self.Max_state) * self.Feat
                + (self.Max_state * ii * self.Feat)
            )  # Diagonal
            Model = GMMHMM(
                n_components=self.Max_state,
                n_mix=ii,
                covariance_type=self.Cov_Type,
                params="stmcw",
                init_params="stmcw",
